...
public abstract class AbstractWebAuthnVirtualTest implements UseVirtualAuthenticators {
    ...
    @InjectEvents(ref = "test")
    Events events;

    @InjectOAuthClient(ref = "test")
    ...
    public UserResource userResource() {
        return ApiUtil.findUserByUsernameId(managedRealm.admin(), USERNAME);
    }
    ...
    protected void authenticateDefaultUser(boolean shouldSuccess) {
        authenticateUser(managedUser.getUsername(), managedUser.getPassword(), shouldSuccess);
    }
