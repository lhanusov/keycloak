...
public class AssertAdminEvents implements BeforeEachCallback {
    ...
    public AssertAdminEvents(Events events, Keycloak adminClient) {
        this.events = events;
    ...
    // Need testing client access
    private AdminEventRepresentation fetchNextEvent() {
        return new AdminEventRepresentation();//context.getTestingClient().testing().pollAdminEvent();
    }
